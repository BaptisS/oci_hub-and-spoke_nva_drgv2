...
export ssh_public_key="ssh-rsa AAAabcdefghijklmnopqrstuvwxyz"
...
#export drgspokesrdstats='[{"action":"ACCEPT","matchCriteria":[{"drgAttachmentId":"'$drg1_attach_sharedvcn_ocid'","matchType":"DRG_ATTACHMENT_ID"}],"priority":"1"}]'
...
#DRG Route Distribution Statement Creation 
#oci network drg-route-distribution-statement remove --route-distribution-id $drg1_rd_sharedvcn_ocid --statement-ids $drg1_rd_sharedvcn_stat_id
